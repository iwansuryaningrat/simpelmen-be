...
//     const user_id = req.user_id;
//     const product_id = req.params.id;
//     const { order_total_price, order_quantity , order_note , order_price , order_design_image , order_design, order_payment_method , order_payment_status,panjang_1, panjang_2,lebar_1,lebar_2,tinggi_1,tinggi_2 , order_discount, order_last_payment_date,order_detail_finishing_id,order_detail_material_id,order_detail_sablon,order_detail_shape} = req.body;
//     db.sequelize.transaction(function (t) {
...
//                     //where order_detail : order_detail_order_id = order.order_id, if order_detail_finishing = null, order_detail_product_id = product_id
//                     where: { order_detail_order_id: order.order_id, order_detail_product_id: product_id , order_detail_finishing_id: order_detail_finishing_id, order_detail_material_id: order_detail_material_id, order_detail_sablon: order_detail_sablon, order_detail_shape: order_detail_shape },
//                 },{ transaction: t })
//                 .then((data) => {
//                     if (data) {
