                                          ...
                                          <tr style="border-bottom: 1px solid rgba(0,0,0,.05);">
                                              ...
                                              <tr style="border-bottom: 1px solid rgba(0,0,0,.05);">
                                                  ...
                                                  <td valign="middle" width="30%" style="text-align:left; padding: 0 2.5em;">
                                                      <span class="price" style="color: #000; font-size: 15px;">Pesanan diproses dengan pembayaran sudah lunas</span>
                                                  </td>
                                              </tr>
                                      </table>
                                  </tr><!-- end tr -->
                                      ...
                                      <table class="bg_white" role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%">
                                          <tr style="border-bottom: 1px solid rgba(0,0,0,.05);">
                                              ...
                                              <tr style="border-bottom: 1px solid rgba(0,0,0,.05);">
                                                  ...
                                                  <td valign="middle" width="30%" style="text-align:left; padding: 0 2.5em;">
                                                      <span class="price" style="color: #000; font-size: 15px;">Pesanan diproses dengan pembayaran belum lunas</span>
                                                  </td>
                                              </tr>
                                      </table>
                                  </tr><!-- end tr -->
