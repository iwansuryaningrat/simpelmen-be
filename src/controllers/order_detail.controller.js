            ...
            .then((data) => {
              return Products.findOne(
                ...
                return Orders.update(
                  {
                    order_code: `${order.order_id}/BIKDK/${
                      data.product_category
                    }/${romanMonth[month - 1]}/${year}`,
                  },
            ...
            return Order_Status.update(
              {
                ...
                order_status_description:
                  "Watting for Approve Admin Customer Service",
              },
              {
                where: {
                ...
                include: [
                  {
                    ...
                    attributes: {
                      exclude: [
                        "product_finishing_product_id",
                        "product_finishing_created_at",
                        "product_finishing_updated_at",
                      ],
                    },
                  },
                  {
                    ...
                    attributes: {
                      exclude: [
                        "product_material_product_id",
                        "product_material_created_at",
                        "product_material_updated_at",
                      ],
                    },
                  },
                ],
